...
public class ClientChatScreen extends JFrame {
	...
	public ClientChatScreen() throws UnknownHostException, IOException {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(ClientChatScreen.class.getResource("/image/chaticon.png")));
		...
		lblNewLabel.setIcon(new ImageIcon(ClientChatScreen.class.getResource("/image/profile.png")));
